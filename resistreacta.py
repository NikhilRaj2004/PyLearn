...
st.title("02341A0259-PS8(2205A21032 SARIMALLA NIKHIL RAJ)")
st.header("Transformer Winding Resistance and Reactance Calculator")
st.subheader("Calculate the winding resistance (R1),and reactance (x1) of a transformer based on short circuit test measurements like VSC,ISC and WSC:")
